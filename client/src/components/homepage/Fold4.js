    ...
    <Wrap id='fold_4'>
      ...
      <FormWrap>
        <Form name="contact" method="post">
          ...
          <Icons>
            <Links>
              <a href="https://github.com/kurt-waizmann" target="_blank"><Img src={GitHub} alt="LinkedIn Link" /></a>
              <a href="https://www.linkedin.com/in/kurt-waizmann" target="_blank"><Img src={LinkedIn} alt="GitHub Link" /></a>
            </Links>
